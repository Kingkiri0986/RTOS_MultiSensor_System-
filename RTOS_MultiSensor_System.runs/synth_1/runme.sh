...
HD_PWD='C:/Users/param/.Xilinx/RTOS_MultiSensor_System/RTOS_MultiSensor_System.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rtos_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rtos_top.tcl
