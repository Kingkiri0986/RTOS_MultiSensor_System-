...
REM
REM Generated by Vivado on Fri Dec 26 00:00:41 +0530 2025
...
echo "xvlog --incr --relax -prj rtos_testbench_vlog.prj"
call xvlog  --incr --relax -prj rtos_testbench_vlog.prj -log xvlog.log
